		...
		<div class="row align-items-center justify-content-center hd-cover-small">
			<div class="col-lg-10">
				<div class="generic-banner-content">
					<h1 class="text-white" style="text-transform:uppercase;">Messages</h1>
                    <p class="text-white">Have a chat with friends, with patners and people you can work for</p>
				</div>							
			</div>
        </div>
    </div>
                    ...
                    <li @if($message['unread'] > 0) style="background:#EEEFFF" @endif>
                        ...
                        <div class="hd-not-description">
                            ...
                            <a href="{{ route('session.messages.user', $message['message']->userFrom->username) }}">
                                <h4>{{ $message['message']->userFrom->name }} <span><span>@</span>{{ $message['message']->userFrom->username }}</span></h4>
