...
<div class="container hd-big-margins">
    <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row" id="hd-gender">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="type" name="type" class="nice-select wide">
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Town / City') }}</label>
                            <div class="col-md-6">
                                <input id="town" type="town" class="form-control" name="town" required>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <script type="text/javascript">getUserCurrentLocation("town", "country", "", "s");</script>
        @if(count($errors) > 0)
