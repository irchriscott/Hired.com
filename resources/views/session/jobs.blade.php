...
<section class="hd-user-menu">
    ...
    <div class="hd-menu-user nav-active-border">
        ...
        <ul class="nav nav-md">
            ...
            <li class="nav-item inline">
                <a class="nav-link active" href="{{ route('session.jobs') }}">
        ...
        <a href="{{ route('job.create') }}?type=Job" class="hd-btn-right genric-btn primary radius">Add New Job</span></a>
    </div>
