            ...
            <div class="hd-comment" style="padding-bottom:13px;">
                ...
                <div class="hd-about">
                    ...
                    <div class="meta-bottom d-flex justify-content-between">
                        ...
                        <p><span class="lnr lnr-briefcase"></span><a href="{{ route('user.jobs', $like->user->username) }}"> 6 Jobs</a></p>
...
@else
    <p class="hd-error" style="margin:30px 0;">NO LIKES TO THIS PROFILE</p>
@endif